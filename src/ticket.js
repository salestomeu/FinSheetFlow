...
function procesarTicketEInsertar(blobImagen) {
...
function procesarCarpetaTickets() {
    ...
    while (files.hasNext()) {
        ...
        if (mimeType.startsWith('image/') || mimeType === 'application/pdf') {
            ...
            try {
                ...
                procesarTicketEInsertar(file.getBlob());
...
// Esta es la función que debe apuntar tu Trigger de Google Apps Script
function ejecutarPipelineDiario() {
    Logger.log("Iniciando escaneo de imágenes y PDFs (Tickets)...");
    procesarCarpetaTickets(); // Tu función de Gemini existente
}